...
format: 
  revealjs:
    ...
    footer: "iamolumide.quartopub.com/Africa-R-Meetup-Presentation"
    incremental: true
    smaller: true
    scrollable: true
    code-fold: show
...
![](images/chip-huyen.png){fig-align="center" width="200"}
...
test_df %>% head(., n = 10) %>% DT::datatable(.)
```
:::

## Variable Importance

v![](images/variable-importance-plot.png){fig-align="center" width="2000"}
...
##  {auto-animate="true" background-transition="fade" visibility="uncounted"}

::: {style="margin-top: 200px; font-size: 3em; color: red;"}
![](images/200w.gif){fig-align="default"}
:::
